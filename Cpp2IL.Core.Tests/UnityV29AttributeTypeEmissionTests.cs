...
{
    [Test]
    public void IndexedTypeValuesRequireCompleteExactEmissionIncludingNestedBoxes()
    {
        ...
        try
        {
            ...
            Assert.That(assessment.IdentitiesEmitted, Is.True);
            ...
            Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(sourceAttributes[typeArrayIndex], typeArrayEmitted), Is.True);
            try
            {
                ...
                try
                {
                    ...
                    Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(sourceAttributes[typeArrayIndex], typeArrayEmitted), Is.False,
            ...
            try
            {
                ...
                Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(sourceAttributes[objectArrayIndex], objectArrayEmitted), Is.True);
                var directObjectArray = new CustomAttributeArgument(objectArrayBox.Type, objectArrayValues);
                Assert.That(UnityV29AttributeTypeProvenance.MatchesIndexedTypeValues(objectArraySource, directObjectArray, objectArrayBox.Type), Is.True,
                    "A direct object[] can start with a boxed Type without boxing the whole array.");
                Assert.That(UnityV29AttributeTypeProvenance.MatchesIndexedTypeValues(objectArraySource,
                ...
                objectArrayEmitted.Signature = WithFixed(objectArraySignature,
                    new CustomAttributeArgument(objectArraySignature.FixedArguments[0].ArgumentType,
                        new BoxedArgument(objectArrayBox.Type, objectArrayValues)));
                Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(sourceAttributes[objectArrayIndex], objectArrayEmitted), Is.False,
            ...
            Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(namedSource, namedEmitted), Is.True);
            try
            {
                ...
                Assert.That(UnityV29AttributeTypeProvenance.HasMatchingIndexedTypeValues(namedSource, namedEmitted), Is.False,
            ...
            try
            {
                Assert.That(UnityV29AttributeTypeProvenance.AssessEmission(app, ["AttributeParameterFixture"]).Single().IdentitiesEmitted, Is.False);
            }
            ...
            Assert.That(UnityV29AttributeTypeProvenance.AssessEmission(app, ["AttributeParameterFixture"]).Single().IdentitiesEmitted, Is.True);
        }
