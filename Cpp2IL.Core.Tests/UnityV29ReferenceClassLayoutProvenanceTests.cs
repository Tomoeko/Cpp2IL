...
public class UnityV29ReferenceClassLayoutProvenanceTests
{
    ...
    public void ClassPairWithIdenticalPlayerFactsIsReportedButUnrelatedTypesAreExcluded()
    {
        ...
        var packOnly = new Il2CppTypeDefinition { Bitfield = classBits | (1u << 11) };
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(UnityV29ReferenceClassLayoutProvenance.HasUnemittedClassLayout(packOnly), Is.True);
    ...
    public void MissingClassLayoutReportsUnknownSizeAndStrictSourceRejection()
    {
        ...
        try
        {
            ...
            var packOnlyDefinition = new Il2CppTypeDefinition { Bitfield = 8336 | (1u << 11) };
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(layout.GetProperty("UnemittedClassLayoutCount").GetInt32(), Is.EqualTo(4));
                ...
                Assert.That(types.Select(type => type.GetProperty("ClassLayoutEmission").GetString()),
                    Is.All.EqualTo("ClassLayoutRowOmitted"));
    ...
    [Test]
    public void PackOnlyClassRejectsStrictSourceWithoutClaimingUnknownDeclaredSize()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(report.ReferenceClassLayoutMetadata.Single().UnemittedClassLayoutCount, Is.EqualTo(1));
