...
/// <summary>Emits the immediate base call authenticated by the folded native chain.</summary>
internal static class X64GuardedBaseConstructorRecovery
{
    internal static bool TryGenerate(MethodAnalysisContext method,
        MethodDefinition definition)
    {
        if (X64GuardedBaseConstructorProof.Find(method) is not { } evidence)
            return false;
