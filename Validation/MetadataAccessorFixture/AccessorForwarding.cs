...
namespace MetadataAccessorFixture
{
    ...
    {
        // Keep the field read in a separate managed method so its metadata
        // initialization belongs to this method. Native inlining is unverified.
    ...
    public static class Forwarder
    {
        ...
        {
            Preparation.Prepare();
            return Receiver.Receive(Accessor.ReadCurrent());
        }
        ...
        {
            Preparation.Prepare();
            return Receiver.Receive(Accessor.ReadCurrent(), number);
        }
    }
}
