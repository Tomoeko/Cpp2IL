...
PROFILES = {name: FIXTURE_PROFILES[name] for name in (
    "catch-divide", "exception-regions", "array-access", "array-call", "reference-field", "field-guard", "scalar-truncation", "loop-calls", "word-fields", "integer-extensions", "byte-fields",
