...
namespace RecoveryValidation
{
    public static class BehaviorProbe
    {
        ...
        private static object DeclarationFacts()
        {
            ...
            var accessor = typeof(Accessor).GetMethod("ReadCurrent", flags);
            ...
            return new Dictionary<string, object>
            {
                ...
                { "accessorExact", accessor != null && accessor.ReturnType == typeof(object) &&
                    accessor.GetParameters().Length == 0 &&
                    (accessor.GetMethodImplementationFlags() & MethodImplAttributes.AggressiveInlining) != 0 &&
                    (accessor.GetMethodImplementationFlags() & MethodImplAttributes.NoInlining) == 0 },
                ...
                { "separateTypes", typeof(Forwarder) != typeof(SharedState) &&
                    ...
                    typeof(Accessor) != typeof(Forwarder) &&
                    typeof(Accessor) != typeof(SharedState) },
                { "noStaticConstructors", typeof(Forwarder).TypeInitializer == null &&
                    ...
                    typeof(Accessor).TypeInitializer == null &&
